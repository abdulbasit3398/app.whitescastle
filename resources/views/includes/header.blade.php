<header class="main-header">
	<div class="d-flex align-items-center logo-box justify-content-between">
		...
		<a href="index.html" class="logo">
			<!-- logo-->
			<div class="logo-lg">
				<span class="light-logo"><img src="{{asset('assets/admin/images/logo-whitecastle.jpg')}}" alt="logo" style="height: 52px;"></span>
				<span class="dark-logo"><img src="{{asset('assets/admin/images/logo-whitecastle.jpg')}}" alt="logo" style="height: 52px;"></span>
			</div>
		</a>	
	</div>  
	<!-- Header Navbar -->
